...
export default function TransModal() {
  const { closeTransModal, isOpenedTransModal } = useModal();

  if (!isOpenedTransModal) return null;
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center bg-black rounded-md p-[32px] h-full md:h-auto pt-[150px] md:pt-4 flex-col gap-[32px] animate__animated animate__fadeInDown animate__faster relative lg:w-[800px] w-[100%] md:w-[500px] min-w-[350px]">
        <div className="cursor-pointer" onClick={closeTransModal}>
